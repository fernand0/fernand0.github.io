...
No estoy muy seguro sobre en qué habrá terminado esto pero me parece interesante por varios motivos: [Ubuntu disables Intel GPU security mitigations, promises 20% performance boost](https://arstechnica.com/security/2025/06/ubuntu-disables-intel-gpu-security-mitigations-promises-20-performance-boost/).
